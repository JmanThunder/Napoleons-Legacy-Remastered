...
country = {
	...
	NONCORE_TAX_PENALTY = -0.025, -- -5% for each non-core in state
	...
	WRONG_REFORM_RADICAL_IMPACT = 20,
	TECH_YEAR_SPAN = 140,
	...
	PARTY_LOYALTY_HIT_ON_WAR_LOSS = 0.50, -- Drops the ruling party loyalty if war is lost.
...
diplomacy = {
	...
	CB_DETECTION_CHANCE_BASE = 5, -- chance out of 1000 every day
...
pops = {
	...
	ISSUE_MOVEMENT_JOIN_LIMIT = 9,
	ISSUE_MOVEMENT_LEAVE_LIMIT = 8,
